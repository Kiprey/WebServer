...
- 单个测试
  ...
  # POST 请求
  ## 找不到路由
  curl -X POST http://localhost:8080/api/bind1 \
      -H "Content-Type: application/json" \
      -d '{"deviceid": "f60da85d-26b2-402b-84f4-b35ee14752f3"}'
  ## JSON 无法解析
  curl -X POST http://localhost:8080/api/bind \
    -H "Content-Type: application/json" \
